          ...
          <div class="card-body">
            <form action="{{ route("profile.update", [$user->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-10">
                  <select class="form-control select2" name="city_id">
                    ...
                    @foreach($cities as $city)
                        <option value="{{$city->id}}" @if(!empty($user->city->id)) {{$city->id == $user->city->id ? 'selected' : ''}} @endif>{{ $city->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="dob" id="dob" value="{{$user->dob}}" required>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Hobbies</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="hobbies" value="{{$user->hobbies}}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">About Me</label>
                <div class="col-sm-10">
                  <textarea class="form-control" name="aboutme">{{$user->aboutme}}</textarea>
                </div>
              </div>
              <div class="form-group row">
